...
public class JdbcCursor {
    ...
    public void setPageSize(int pageSize) {
        ...
        cursor.setCursorBufferSize(pageSize == 0 ? SqlStatement.DEFAULT_CURSOR_BUFFER_SIZE : pageSize);
    }
    ...
    public String getColumnName(int index) {
        return cursor.getRowMetadata().getColumn(index).getName();
    }

    public SqlColumnType getColumnType(int index) {
        return cursor.getRowMetadata().getColumn(index).getType();
    }
